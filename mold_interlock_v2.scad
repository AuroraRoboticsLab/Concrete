...
scale=2; // 1x: 100mm;  2x: 200mm, etc
R = scale*48.0; // radius from center to start of part
dR = scale*5.0; // change in radius for interlock
...
{
    dz=5/scale; //<- degrees of vertical space on mating surfaces
...
make_wall();  
// make_wall(1.61); // minimum viable thickness
